...
const Footer = () => {
    return (
        <footer className="lg:w-9/12 mx-auto mt-32 px-10 lg:px-0">
            {/* footer top part */}
            <section className=" flex flex-col lg:flex-row text-center lg:text-start items-center text-white  justify-between mb-10">
            ...
            <section className="mt-7">
                <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-6 font-semibold ">
                    <div className="flex items-center gap-3 text-2xl text-white">
                        ...
                        <p><FaDiscord /></p>
                        <p><FaRegEnvelope /></p>
                        <p className="font-sans font-light text-base lg:block hidden"><small>reachus@fandora.app</small></p>
                    </div>
                    <div className="flex flex-col lg:flex-row justify-center lg:justify-between  items-center gap-2 lg:gap-10 text-2xl text-white">
                        <p className="font-sans font-light text-base lg:hidden block"><small>reachus@fandora.app</small></p>
